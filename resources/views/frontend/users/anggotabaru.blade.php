...
@section('content')
    ...
    @component('components.frontend.page_content')
        ...
        <div class="d-flex align-items-center p-3 my-1 text-white bg-success rounded shadow-sm">
            <div class="lh-1">
              <h1 class="h6 mb-0 text-white lh-1">Formulir Pendaftaran Anggota KOBI</h1>
            </div>
        ...
        <div>
            <div class="my-3 p-3 bg-body rounded shadow-sm">
                <h6 class="border-bottom pb-2 mb-0">Mohon isi formulir dibawah ini</h6>
                <form id="store">
                  @csrf
                  <div class="row">
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label for="univ" class="form-label mt-3">Nama Universitas</label>
                        <input name="nama_univ" type="text" class="form-control" id="univ">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label for="kaprodi" class="form-label mt-3">Nama Kaprodi/Kajur</label>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label for="jurusan" class="form-label mt-3">Nama Prodi/Jursan</label>
                        <input name="nama_jurusan" type="text" class="form-control" id="jurusan">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label for="email" class="form-label mt-3">Email Kaprodi/Jurusan</label>
                        <input name="email_kaprodi" type="email" class="form-control" id="email">
                      </div>
                    </div>
                  </div>
                  <div class="mb-3">
                    <label for="alamat" class="form-label">Alamat Pengiriman Sertifikat</label>
                    <textarea name="alamat" class="form-control" id="alamat" rows="3" name="alamat"></textarea>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="mb-3">
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label for="kota" class="form-label mt-3">Kabupaten/Kota</label>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label for="name" class="form-label mt-3">Nomor WhatsApp/Narahubung</label>
                            <input name="no_wa" type="text" class="form-control phone-number">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="mb-3">
                          <label for="pos" class="form-label mt-3">Kode Pos</label>
                          <input name="kode_pos" type="number" class="form-control" id="pos">
                        </div>
                      </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="formFile" class="form-label mt-3">Unggah Bukti Pembayaran</label>
                            <input name="bukti_pembayaran" class="form-control" type="file" id="formFile">
                        </div>
                    </div>
                  </div>
                  <button id="btnSend" type="submit" class="w-btn w-btn my-3">Daftar</button>
                </form>
