...
<div class="container-fluid">
    <div class="add-category card shadow mb-4">
        <div class="card-header py-3">
              <h3 class="h5 mb-0 text-gray-800 d-inline">Tambah Publikasi</h3>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                        <input name="nama_dokumen" type="text" class="form-control" placeholder="Nama publikasi">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                        <input name="file_dokumen" type="file" class="form-control" placeholder="Nama publikasi" value="0">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
