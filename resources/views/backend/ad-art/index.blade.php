...
<div class="container-fluid">
    <div class="add-category card shadow mb-4">
        <div class="card-header py-3">
              <h3 class="h5 mb-0 text-gray-800 d-inline">Update AD/ART</h3>
        </div>
        <div class="card-body">
    ...
    @component('components.backend.card-table')
        @slot('header')
        <h3 class="h5 mb-0 text-gray-800 d-inline">AD/ART KOBI</h3>
        @endslot
        @slot('dropdown')
...
<script src="{{ asset('backend') }}/js/sweet_alert.min.js"></script>
    <script>
        ...
        $('#formUpdateAdArt').submit(function (event) {
            ...
            $.ajax({
                url: BaseUrl+'/api/admin/ad-art/'+id,
                data: data,
                method: 'POST',
                processData: false,
                contentType: false,
