            ...
            <div class="card-header">
                <div class="col-sm-12">
                    <div class="d-sm-flex align-items-center justify-content-between">
                        <h3 class="h5 mb-0 text-gray-800 d-inline mr-5">Buat Event Baru</h3>
                        <a href="/dashboard" class="d-inline ml-auto btn btn-sm btn-primary"><i class="fas fa-arrow-left"></i> Back</a>
                    </div>
                </div>
            </div>
            <!-- Card Body -->
                   ...
                   @csrf
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <select class="form-control @error('category_id') ? is-invalid @enderror" name="event_category_id">
        ...
        complete: (response) => {
            if(response.status == 201) {
                swal({
                  ...
                  .then(() => {
                    window.location.replace(BaseUrl+'/admin/event');
                  });
            }else {
    ...
    $.ajax({
        ...
        complete: (response) => {
            if(response.status == 200) {
                ...
                $('select[name=event_category_id]').html(append);
            }else {
                console.log('Gagal');
            }
        }
